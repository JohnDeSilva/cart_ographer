...
def _seed_approved_restaurants(
    ...
    approved_definitions = [
        (
            ...
            _make_location(
                database_session,
                models.LocationCategory.INTERSECTION,
                road_1="5th Avenue",
                road_2="Main Street",
                city="Portland",
                state="OR",
                lat=45.5170,
                lng=-122.6784,
                description="Downtown, 5th & Main Street",
            ),
            time(11, 0, 0),
            time(20, 0, 0),
            True,
        ...
        (
            ...
            _make_location(
                database_session,
                models.LocationCategory.FOOD_COURT,
                venue_name="West End Market",
                stall_number="Stall 7",
                city="Portland",
                state="OR",
                lat=45.5210,
                lng=-122.6840,
                description="West End Market, Stall 7",
            ),
            time(8, 0, 0),
            time(16, 0, 0),
            True,
        ...
        (
            ...
            _make_location(
                database_session,
                models.LocationCategory.STREET_ADDRESS,
                address="42 Warehouse Row",
                city="Portland",
                state="OR",
                lat=45.5300,
                lng=-122.6670,
                description="Industrial District, 42 Warehouse Row",
            ),
            time(17, 0, 0),
            time(2, 0, 0),
            False,
        ...
        (
            ...
            _make_location(
                ...
                lat=45.5152,
                lng=-122.6784,
                description="45 Main Street, Suite 100",
            ),
            time(12, 0, 0),
            time(22, 0, 0),
            True,
        ...
        (
            ...
            _make_location(
                ...
                description="Various - check social media for daily location",
                lat=45.5110,
                lng=-122.6820,
            ),
            time(10, 0, 0),
